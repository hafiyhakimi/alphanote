...
import 'package:alphanoteapp/toDoList/components/add_todo_modal_bottom_sheet.dart';
import 'package:alphanoteapp/toDoList/components/search_bar.dart';
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            const Expanded(child: SearchBarNew()),
            IconButton(
              onPressed: () {},
